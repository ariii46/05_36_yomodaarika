...
<body>
    ...
    if ($error == 0) {
        echo '<dl>';
        echo '<dt>自分で何か始めたいと思ったことはありますか？：</dt><dd>' . $gendername . '</dd>';
        ...
        echo '<p class="message"><a href="questionnaire6.php">集計結果ページへ</a></p>';
    } else {
        echo '<p class="message error">恐れ入りますが<a href="questionnaire4.php">アンケート入力ページ</a>に戻り、アンケートの項目全てにお答えください。</p>';
    }
