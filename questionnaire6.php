...
?>
    ...
    <table>
        ...
        <tbody>
            <tr>
                <td>自分で何か始めたいと思ったことはありますか？</td>
                <?php
                // 男女の比率計算
                $male_rate   = round($results[0] / $results[18] * 100);
                $female_rate = round($results[1] / $results[18] * 100);

                echo '  <td>はい：' . $results[0] . '人 いいえ：' . $results[1] . '人</td>';
                echo '  <td>はい：' . $male_rate . '% いいえ：' . $female_rate . '%</td>';
                ?>
            </tr>
            <tr>
                <td>年齢</td>
...
fclose($fp);
echo '<p class="link"><a href="questionnaire4.php">アンケートページへ戻る</a></p>';
?>